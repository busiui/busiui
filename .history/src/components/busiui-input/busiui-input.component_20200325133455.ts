...
export class BusiUiCheckbox extends HTMLElement {
    ...
    updateStyle() {
        ...
        const html = [
            ...
            `<label for="exampleInputEmail1" class="col-sm-4">${this.conf['lable']}</label>`,
            '<input type="text" class="form-control col-sm-8" placeholder="Username" aria-describedby="basic-addon1">',
            '</div>'
        ];
...
customElements.define('busiui-input', BusiUiCheckbox);