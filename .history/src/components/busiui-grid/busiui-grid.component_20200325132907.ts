...
export class BusiUiGrid extends HTMLElement {
    ...
    updateStyle() {
        ...
        const html = [
            ...
            '            <busiui-checkbox class="form-group" conf=\'{\"lable\":\"部门\",\"ngModel\":\"department\"}\'></busiui-checkbox>',
            '            <busiui-radio class="form-group" conf=\'{\"lable\":\"上级\",\"ngModel\":\"department\"}\'></busiui-radio>',
            '            <busiui-select class="form-group" conf=\'{\"lable\":\"级别\",\"ngModel\":\"department\"}\'></busiui-select>',
            '            <busiui-input class="form-group" conf=\'{\"lable\":\"描述\",\"ngModel\":\"department\"}\'></busiui-input>',
