...
export class BusiUiGrid extends HTMLElement {
    ...
    updateStyle() {
        ...
        const html = [
            ...
            '            <busiui-input conf=\'{\"lable\":\"部门\",\"ngModel\":\"department\"}\'></busiui-input>',
            '            <busiui-radio conf=\'{\"lable\":\"部门\",\"ngModel\":\"department\"}\'></busiui-radio>',
            '            <busiui-select conf=\'{\"lable\":\"部门\",\"ngModel\":\"department\"}\'></busiui-select>',
