...
export class BusiUiGrid extends HTMLElement {
    ...
    updateStyle() {
        ...
        const html = [
            ...
            '            <busiui-checkbox conf=\'{\"lable\":\"部门\",\"ngModel\":\"department\"}\'></busiui-checkbox>',
            '            <busiui-radio conf=\'{\"lable\":\"上级\",\"ngModel\":\"department\"}\'></busiui-radio>',
            '            <busiui-select conf=\'{\"lable\":\"级别\",\"ngModel\":\"department\"}\'></busiui-select>',
            '            <busiui-input conf=\'{\"lable\":\"秒速\",\"ngModel\":\"department\"}\'></busiui-input>',
