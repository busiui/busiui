...
export class BusiUiGrid extends HTMLElement {
    ...
    $: any = this.win['$'];
    table: any;
    selesctOpConfig: Array<BusiuiSelectOpConfigModel>;
        ...
        this.selesctOpConfig = [
            {
                ...
                input_type: "select_code",//           VARCHAR2(4)                    null,
                ...
                ng_model: "select_code",//             VARCHAR2(50)                   null,
    ...
    genComponent(opConfig: BusiuiSelectOpConfigModel) {
        ...
        switch (opConfig.input_type) {
            ...
            case '3':
            case '4':
                ret = '<div class="col-md-4"><busiui-checkbox class="form-group" conf=\'{\"lable\":\"部门\",\"ngModel\":\"Name\"}\'></busiui-checkbox></div>';
                break;
            case '5':
            case '6':
                ret = '<div class="col-md-4"><busiui-checkbox class="form-group" conf=\'{\"lable\":\"部门\",\"ngModel\":\"Name\"}\'></busiui-checkbox></div>';
            ...
            case '11':
                ...
                break;
            case '12':
                ret = '<div class="col-md-4"><busiui-radio class="form-group" conf=\'{\"lable\":\"上级\",\"ngModel\":\"department\"}\'></busiui-radio></div>';
                break;
            case '13':
                ret = '<div class="col-md-4"><busiui-select class="form-group" conf=\'{\"lable\":\"级别\",\"ngModel\":\"level\"}\'></busiui-select></div>';
                break;
        }
