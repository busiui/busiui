...
export class BusiUiGrid extends HTMLElement {
    ...
    eventService: EventService; //事件
    queryDTO: any = {}; //查询区域DTO
    gridBtnConfig: Array<BusiuiGridBtnConfigModel> = [];
    gridConfig: Array<BusiuiGridConfigModel> = [];
    gridColBtnConfig: Array<BusiuiiGridColConfig> = [];
