...
export class BusiUiGrid extends HTMLElement {
    ...
    updateStyle() {
        ...
        const html = [
            ...
            '            <div class="col-md-4"><busiui-checkbox class="form-group" conf=\'{\"lable\":\"部门\",\"ngModel\":\"department\"}\'></busiui-checkbox></div>',
            '            <div class="col-md-4"><busiui-radio class="form-group" conf=\'{\"lable\":\"上级\",\"ngModel\":\"department\"}\'></busiui-radio></div>',
            '            <div class="col-md-4"><busiui-select class="form-group" conf=\'{\"lable\":\"级别\",\"ngModel\":\"department\"}\'></busiui-select></div>',
            '            <div class="col-md-4"><busiui-input class="form-group" conf=\'{\"lable\":\"描述\",\"ngModel\":\"department\"}\'></busiui-input></div>',
