...
export class BusiUiSelect extends HTMLElement {
    ...
    Init() {
        ...
        console.log(input);
        input.bind( 'input blur focus change',(event: any) => self.onChange(event))
...
customElements.define('busiui-input', BusiUiSelect);