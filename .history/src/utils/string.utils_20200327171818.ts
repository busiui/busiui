...
export class StringUtils {
    ...
    /**
     * 根据cpt模板导出需要的文件，可包括excel，pdf等
     * 
     * @param reportPath
     *            fr的模板文件路径
     * @param reportparams
     *            fr的模板文件参数 例如：userId=123&entSysId=456
     * @param fileType
     *            要导出的文件类型，可选项："Excel2003", "Excel2007", "Word", "Pdf", "Txt", "Csv", "Svg", "Image",默认excel
     * @param filename
     *            要到出的文件名称，例如：123.xls
     * @Author sunbaojin 2018.01.08 PM 15:00
     * @Description 将使用指定分割符的字符串进行排序，例如:D1，E1，F1，D2，E2 处理后的结果就是：D1，D2，E1，E2，F1
     * @returns 处理后的字符串
     */
    // exportReportByFileTypeopenwindow(reportPath, reportparams, fileType, filename) {
    //     Constant.PARAMS.reportBiz = {};
    //     Constant.PARAMS.reportBiz.reportType = "export";
    //     Constant.PARAMS.reportBiz.reportPath = reportPath;
    //     Constant.PARAMS.reportBiz.filename = filename;
    //     if (fileType == undefined) {
    //         Constant.PARAMS.reportBiz.fileType = "excel";
    //     } else {
    //         Constant.PARAMS.reportBiz.fileType = fileType;
    //     }

    //     Constant.PARAMS.reportBiz.reportparams = reportparams;
    //     var url = '/include/openreport.jsp';
    //     $("#openwindow").load(ctxRoot + url, {} function () {
    //     });
    // }
    /**
     * 
